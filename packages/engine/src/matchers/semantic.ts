import type { Rule, Matcher, MatcherContext, MatchResult } from "../types.js"
...
function inverseDocumentFrequency(docs: readonly (readonly string[])[]): ReadonlyMap<string, number> {
  const n = docs.length
