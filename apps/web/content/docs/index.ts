...
const doc: DocPage = {
  ...
  title: "Introduction",
  description:
    "Rulebound is a deterministic guardrail platform for AI coding agents. rulebound check is the authoritative gate; advisory matching feeds the planning loop.",
