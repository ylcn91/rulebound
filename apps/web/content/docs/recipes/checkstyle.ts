...
const doc: DocPage = {
  slug: "recipes/checkstyle",
  title: "Checkstyle Recipe",
  description:
    "Checkstyle enforces Java style and structural rules. Rulebound parses target/checkstyle-result.xml and emits one deterministic finding per <error> element.",
  content: `## Checkstyle recipe
...
- [Java Pack](/docs/recipes/java-pack) — Checkstyle alongside PMD, SpotBugs, ArchUnit.
`,
}
