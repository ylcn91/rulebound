...
const doc: DocPage = {
  slug: "recipes/semgrep",
  title: "Semgrep Recipe",
  description:
    "Semgrep is a pattern-based static analyzer with SARIF output. Rulebound consumes that SARIF directly and reports each result as an analyzer finding.",
  content: `## Semgrep recipe
...
- [gitleaks recipe](/docs/recipes/gitleaks) — pair with gitleaks for full security coverage.
`,
}
