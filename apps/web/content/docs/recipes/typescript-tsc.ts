...
const doc: DocPage = {
  slug: "recipes/typescript-tsc",
  title: "TypeScript (tsc) Recipe",
  description:
    "tsc --noEmit is the canonical TypeScript type check. Rulebound wraps it as an analyzer check whose verdict comes from the exit code.",
  content: `## TypeScript (tsc) recipe
...
- [ESLint recipe](/docs/recipes/eslint) — pair with ESLint for lint coverage.
`,
}
