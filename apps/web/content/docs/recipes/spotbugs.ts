...
const doc: DocPage = {
  slug: "recipes/spotbugs",
  title: "SpotBugs Recipe",
  description:
    "SpotBugs is a bytecode-level static analyzer for Java. Rulebound reads target/spotbugsXml.xml and emits one finding per <BugInstance>.",
  content: `## SpotBugs recipe
...
- [Java Pack](/docs/recipes/java-pack) — SpotBugs alongside PMD, Checkstyle, ArchUnit.
`,
}
